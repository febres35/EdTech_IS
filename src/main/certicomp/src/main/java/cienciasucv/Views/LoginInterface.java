...
public class LoginInterface extends javax.swing.JFrame {
    ...
    public LoginInterface() {
        ...
        private void initComponents() {
            ...
            btnIniciarSesion = Buttons.getButton("INGRESAR", SizeType.LARGE);
            ...
            public void btnIniciarSesionActionPerformed(ActionEvent e) {
                ...
                LoginController check = new LoginController();

                if (check.checkLoginData(correo, contrasenia)) {
...
//CUANDO PUEDAS PRUEBA ESTO Y ME DICES QUE TAL