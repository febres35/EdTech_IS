...
public class HomeView{
    ...
    protected HomeView(String userName, String userRole){
        ...
        homeButtons.add(Buttons.getButton("Ayuda", SizeType.LARGE));
        homeButtons.add(Buttons.getButton("Cerrar Sesión", SizeType.LARGE));
        ...
        logoPanel.add(LogoFactory.getLogo(SizeType.LARGE));
