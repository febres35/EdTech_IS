...
public class LoginView {
    ...
    public LoginView(){
        ...
        JLabel logoLabel2 = LogoFactory.getLogo(LogoSize.SMALL);
        
        adminButton =  Buttons.getButton("Admin", ButtonSize.LARGE);
        studentButton = Buttons.getButton("Student", ButtonSize.LARGE);
